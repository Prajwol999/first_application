...
class ArithmeticNewView extends StatefulWidget {
  const ArithmeticNewView({super.key});

  @override
  State<ArithmeticNewView> createState() => _ArithmeticNewViewState();
}

class _ArithmeticNewViewState extends State<ArithmeticNewView> {
